...
cnn = loading_model()
st.write("""
# Cloud Based Web Application For Tuberculosis Detection Using CNN App
Built by Aishwarya Ishwar Naik and Team
""")
...
if buffer is None:
    st.text("This model is built for public use by Joshmi K Joy,Aishwarya Ishwar Naik,Anusha Narayan Naik,G Raghvendra")
